"""add new models and schema

Revision ID: e7c086439666
Revises: c4d7f9729c0f
Create Date: 2023-06-07 16:07:21.280085
...
def upgrade():
    ...
    sa.Column('is_class', sa.Boolean(), nullable=False),
    ...
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('is_child_rank', sa.Boolean(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('last_promotion', sa.Date(), nullable=False))
        batch_op.add_column(sa.Column('point_total', sa.Integer(), nullable=False))
        batch_op.add_column(sa.Column('rank_id', sa.Integer(), nullable=True))
        batch_op.create_unique_constraint(None, ['username'])
        batch_op.create_unique_constraint(None, ['is_coach'])
